...
export default function BookingEnginePage() {
  ...
  const cartItemCount = cartAccommodations.length + cartServices.length;
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <div className="px-6 py-3 bg-black/10 border-b border-white/10">
          <div className="flex items-center justify-center gap-2">
            {['search', 'results', 'services', 'cart', 'checkout', 'confirmation'].map((step, i) => (
              <div key={step} className="flex items-center">
                <button
                  onClick={() => {
                    if (step === 'search' || (step === 'results' && searchResults.length > 0) || step === 'services' || step === 'cart') {
                ...
                {i < 5 && <ChevronRight className="w-4 h-4 text-white/30 mx-1" />}
              </div>
            ))}
          </div>
        </div>
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="max-w-6xl mx-auto">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        >
                          <option value="niseko">Niseko, Hokkaido</option>
                          <option value="hakuba">Hakuba, Nagano</option>
                          <option value="myoko">Myoko Kogen</option>
                        </select>
                      </div>
                    </div>
                    ...
                    {/* Nights */}
                    <div>
                      <label className="text-xs text-white/60 mb-1 block">Nights</label>
                      <div className="relative">
            ...
            {currentStep === 'checkout' && (
              <div className="space-y-6">
                <h2 className="text-2xl font-light text-white">Checkout</h2>
                ...
                <div className="grid lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white/10 backdrop-blur-xl rounded-xl border border-white/20 p-6">
                      ...
                      <div className="space-y-4">
                        <div className="p-4 bg-amber-500/10 border border-amber-500/30 rounded-lg">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-white/50">Secure payment via Stripe</p>
                            </div>
                        ...
                        <p className="text-xs text-white/40">
                          Your payment is processed securely. We support credit cards, WeChat Pay, and convenience store payments.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white/10 backdrop-blur-xl rounded-xl border border-white/20 p-4 h-fit">
                    ...
                    <button
                      ...
                      disabled={isLoading || !guestInfo.firstName || !guestInfo.lastName || !guestInfo.email || !guestInfo.phone || !guestInfo.country}
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                {showServiceModal.timeSlots.length > 0 && showServiceModal.timeSlots[0] !== 'Any Time' && (
                  <div>
                    <label className="text-xs text-white/60 mb-1 block">Time Slot</label>
                    <select
                      value={serviceTimeSlot}
                      onChange={(e) => setServiceTimeSlot(e.target.value)}
                      className="w-full bg-white/10 border border-white/20 rounded-lg px-3 py-2 text-white text-sm appearance-none"
                    >
